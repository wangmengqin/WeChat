...
<div>
    <div class="_cover-top"  >
        <div class="top-back" >
            <a href="#/tab/contact" style="color:white;"><div class="_ellipsis iconfont icon-return-arrow v-link-active" style="font-size: 16px;"><img src="/img/leftsanjiao.png" style="width:12px;height:19px;line-height: 45px;vertical-align: middle;margin-right: 5px;"/>通讯录</div></a>
        </div>
        <div class="top-other" >
