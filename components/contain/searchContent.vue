		...
		<div class="weui-search-bar weui-search-bar_focusing"  id="searchBar">
			<form class="weui-search-bar__form">
				<div class="weui-search-bar__box">
					...
					<input type="search" class="weui-search-bar__input" id="searchInput" placeholder="搜索" required="" @blur="searchChat" v-model="sea">
	...
	export default {
		...
		methods:{
			searchChat(){
				...
				$.ajax({
					type:"post",
					url:"http://120.79.182.135:5555/getSearchList",
					data:{
						sea:_this.sea
					},
					async:true,
