...
<div>
  <div class="_cover-top"  >
        <div class="top-back" >
            <a href="#/tab/contact" style="color:white;float: left;"><div class="_ellipsis iconfont icon-return-arrow v-link-active" style="font-size: 16px;"><img src="/img/leftsanjiao.png" style="width:12px;height:19px;line-height: 45px;vertical-align: middle;margin-right: 5px;"/>通讯录</div></a>
        </div>
	...
	export default{
		...
		methods:{
			searchChat(){
				...
				$.ajax({
					type:"post",
					url:"http://120.79.182.135:5555/getstrager",
					dataType:'json',
					data:{
						strager_num:stra
					},
			...
			ADD(){
				...
				$.ajax({
					type:"post",
					url:"http://120.79.182.135:5555/addstrager",
					dataType:'json',
					data:{
					...
					success(data){
						$.ajax({
							type:"post",
							url:"http://120.79.182.135:5555/deletestrager",
							dataType:'json',
							data:{
								Arr:JSON.stringify(self.searchArr)
							},
